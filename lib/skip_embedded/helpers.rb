module SkipEmbedded
  module Helpers
    ...
    def self.included(base)
      ...
      ActionView::Helpers::AssetTagHelper.register_javascript_expansion :skip_embedded => %w[skip_embedded/dropdown_navigation skip_embedded/labeled_text_field skip_embedded/flash_message skip_embedded/iframe_upload]
